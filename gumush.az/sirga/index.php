...
<html>
<head>
	<link rel="alternate" hreflang="az" href="http://gumush.az/sirga/index.php" />
	<meta http-equiv="content-language" content="az" />
	<meta name="keywords" content="gumus sirgalar,gümüş sırğalar,qadin gumusleri,qadin sirqalari,qadın sırğaları,usaq sırgaları,gumus satisi,gumus satisi bakida,sirqalar,qadın və kişi gümüşləri,online gumus satisi" />
	...
	<meta property="og:url" content="http://gumush.az/sirga/" />
	<meta property="og:type" content="website" />
	<meta property="og:title" content="Qadın Gümüş Sırğalarının Onlayn Satışı" />
...
<body onload="pagination_sayisi()">
	...
	<div class="container">
		...
		<h1 class="seo_h1">Gümüş Sırğalar Gumus Sirgalar Qadın Gümüşləri Qadin Gumusleri Kişi Gümüşləri Kisi Gumusleri Qadın Qırğaları Qadin Sirgalari</h1>
		...
		<script type="text/javascript">
			$("a[href='../sirga']").css("background-color","#ED5258");
		</script>
		...
		<!-- FILTER START -->
					<div class="filter_main col-xs-12 col-sm-3">
								...
								//bu funksiya ise dusur, mehsul_sayisi_pagination adli deyiskenin deyeri teyin olunur ve sonra pagination_sayisi() funksiyasi ise dusur, funksiya asagilarda bir yerdedir.
									$.ajax({
									    ...
									    success: function (data){
									        ...
									        $(".s_qiymet_10_30").html(" ("+mehsul_eded[0].s_qiymet_10_30+")");
									        $(".s_qiymet_30_50").html(" ("+mehsul_eded[0].s_qiymet_30_50+")");
									        $(".s_qiymet_50_70").html(" ("+mehsul_eded[0].s_qiymet_50_70+")");
									        $(".s_qiymet_70_100").html(" ("+mehsul_eded[0].s_qiymet_70_100+")");
									        $(".s_qiymet_100_plus").html(" ("+mehsul_eded[0].s_qiymet_100_plus+")");

									        $(".s_ceki_1_5").html(" ("+mehsul_eded[0].s_ceki_1_5+")");
									        $(".s_ceki_5_10").html(" ("+mehsul_eded[0].s_ceki_5_10+")");
									        $(".s_ceki_10_20").html(" ("+mehsul_eded[0].s_ceki_10_20+")");
									        $(".s_ceki_20_30").html(" ("+mehsul_eded[0].s_ceki_20_30+")");
									        $(".s_ceki_30_plus").html(" ("+mehsul_eded[0].s_ceki_30_plus+")");

									        $(".s_yasgrupu_usaq").html(" ("+mehsul_eded[0].s_yasgrupu_usaq+")");
									        $(".s_yasgrupu_boyuk").html(" ("+mehsul_eded[0].s_yasgrupu_boyuk+")");
									    }
									});
						</script>
						...
						<div class="filter_divs kateqoriya col-xs-12">
							...
							<a href="." title="gumus Sirgalar">Sırğalar <span class="mehsul_eded-sirga"></span></a>
						...
						<div class="filter_divs qiymet col-xs-12">
							<p class="on-otuz">10 <i class="fa fa-arrows-h" aria-hidden="true"></i> 30 AZN<span class="s_qiymet_10_30"></span></p>
							<p class="otuz-elli">30 <i class="fa fa-arrows-h" aria-hidden="true"></i> 50 AZN<span class="s_qiymet_30_50"></span></p>
							<p class="elli-yetmis">50 <i class="fa fa-arrows-h" aria-hidden="true"></i> 70 AZN<span class="s_qiymet_50_70"></span></p>
							<p class="yetmis-yuz">70 <i class="fa fa-arrows-h" aria-hidden="true"></i> 100 AZN<span class="s_qiymet_70_100"></span></p>
							<p class="yuz-plus"><i class="fa fa-plus" aria-hidden="true"></i> 100 AZN<span class="s_qiymet_100_plus"></span></p>
						</div>
						...
						<div class="filter_divs ceki col-xs-12">
							<p class="bir-bes">1 <i class="fa fa-arrows-h" aria-hidden="true"></i> 5<span class="s_ceki_1_5"></span></p>
							<p class="bes-on">5 <i class="fa fa-arrows-h" aria-hidden="true"></i> 10<span class="s_ceki_5_10"></span></p>
							<p class="on-iyirmi">10 <i class="fa fa-arrows-h" aria-hidden="true"></i> 20<span class="s_ceki_10_20"></span></p>
							<p class="iyirmi-otuz">20 <i class="fa fa-arrows-h" aria-hidden="true"></i> 30<span class="s_ceki_20_30"></span></p>
							<p class="otuz-plus"><i class="fa fa-plus" aria-hidden="true"></i>  30 <span class="s_ceki_30_plus"></span></p>
						</div>
						...
						<div class="filter_divs age_grupu col-xs-12">
							<p class="usaq">Uşaqlar üçün <span class="s_yasgrupu_usaq"></span></p>
							<p class="boyuk">Böyüklər üçün <span class="s_yasgrupu_boyuk"></span></p>
						</div>
							...
							<script type="text/javascript">
					            ...
					            function ajax(){
					            	$.ajax({
						                type: "POST",
						                url: "sirga_db.php",
						                data: { a: '',d:usaq,e:boyuk,f:bir_bes_gram,g:bes_on_gram,h:on_iyirmi_gram,i:iyirmi_otuz_gram,j:otuz_plus,p:on_otuz,q:otuz_elli,r:elli_yetmis,s:yetmis_yuz,t:yuz_plus,u:st,v:lm},
						                success: function(gelen) {
