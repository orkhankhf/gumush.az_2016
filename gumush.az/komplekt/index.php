...
<html>
<head>
	<link rel="alternate" hreflang="az" href="http://gumush.az/komplekt/index.php" />
	<meta http-equiv="content-language" content="az" />
	<meta name="keywords" content="gumus komplektler,gümüş komplektlər,qadin gumusleri,kisi gumusleri,usaq gumusleri,gumus satisi,gumus satisi bakida,komplektlər,sep,qadın və kişi gümüşləri,online gumus satisi" />
	...
	<meta property="og:url" content="http://gumush.az/komplekt/" />
	<meta property="og:type" content="website" />
	<meta property="og:title" content="Qadın Və Kişi Gümüş Komplektlərinin Onlayn Satışı" />
...
<body onload="pagination_sayisi()">
	...
	<script type="text/javascript">
		$(document).ready(function(){
		    document.title = "Gümüş Komplektlər";
		    setTimeout(function(){
		    	$(".circle").hide();
		    	$(".circle1").hide();
	...
	<div class="container">
		...
		<h1 class="seo_h1">Gümüş Komplektlər Gumus Komplektler Qadın Gümüşləri Qadin Gumusleri Kişi Gümüşləri Kisi Gumusleri Qadın Komplektləri Qadin Komplektleri Kişi Komplektləri Kisi Komplektleri</h1>
		...
		<script type="text/javascript">
			$("a[href='../komplekt']").css("background-color","#ED5258");
		</script>
		...
		<!-- FILTER START -->
					<div class="filter_main col-xs-12 col-sm-3">
								...
								//bu funksiya ise dusur, mehsul_sayisi_pagination adli deyiskenin deyeri teyin olunur ve sonra pagination_sayisi() funksiyasi ise dusur, funksiya asagilarda bir yerdedir.
									$.ajax({
									    ...
									    success: function (data){
									        ...
									        $(".k_qiymet_10_30").html(" ("+mehsul_eded[0].k_qiymet_10_30+")");
									        $(".k_qiymet_30_50").html(" ("+mehsul_eded[0].k_qiymet_30_50+")");
									        $(".k_qiymet_50_70").html(" ("+mehsul_eded[0].k_qiymet_50_70+")");
									        $(".k_qiymet_70_100").html(" ("+mehsul_eded[0].k_qiymet_70_100+")");
									        $(".k_qiymet_100_plus").html(" ("+mehsul_eded[0].k_qiymet_100_plus+")");

									        $(".k_ceki_1_5").html(" ("+mehsul_eded[0].k_ceki_1_5+")");
									        $(".k_ceki_5_10").html(" ("+mehsul_eded[0].k_ceki_5_10+")");
									        $(".k_ceki_10_20").html(" ("+mehsul_eded[0].k_ceki_10_20+")");
									        $(".k_ceki_20_30").html(" ("+mehsul_eded[0].k_ceki_20_30+")");
									        $(".k_ceki_30_plus").html(" ("+mehsul_eded[0].k_ceki_30_plus+")");

									        $(".k_cins_kisi").html(" ("+mehsul_eded[0].k_cins_kisi+")");
									        $(".k_cins_qadin").html(" ("+mehsul_eded[0].k_cins_qadin+")");

									        $(".k_yasgrupu_usaq").html(" ("+mehsul_eded[0].k_yasgrupu_usaq+")");
									        $(".k_yasgrupu_boyuk").html(" ("+mehsul_eded[0].k_yasgrupu_boyuk+")");
									    }
									});
						</script>
						...
						<div class="filter_divs kateqoriya col-xs-12">
							...
							<a href="." title="gumus Komplektler">Komplektlər <span class="mehsul_eded-komplekt"></span></a>
						</div>
						...
						<div class="filter_divs qiymet col-xs-12">
							<p class="on-otuz">10 <i class="fa fa-arrows-h" aria-hidden="true"></i> 30 AZN<span class="k_qiymet_10_30"></span></p>
							<p class="otuz-elli">30 <i class="fa fa-arrows-h" aria-hidden="true"></i> 50 AZN<span class="k_qiymet_30_50"></span></p>
							<p class="elli-yetmis">50 <i class="fa fa-arrows-h" aria-hidden="true"></i> 70 AZN<span class="k_qiymet_50_70"></span></p>
							<p class="yetmis-yuz">70 <i class="fa fa-arrows-h" aria-hidden="true"></i> 100 AZN<span class="k_qiymet_70_100"></span></p>
							<p class="yuz-plus"><i class="fa fa-plus" aria-hidden="true"></i> 100 AZN<span class="k_qiymet_100_plus"></span></p>
						</div>
						...
						<div class="filter_divs ceki col-xs-12">
							<p class="bir-bes">1 <i class="fa fa-arrows-h" aria-hidden="true"></i> 5<span class="k_ceki_1_5"></span></p>
							<p class="bes-on">5 <i class="fa fa-arrows-h" aria-hidden="true"></i> 10<span class="k_ceki_5_10"></span></p>
							<p class="on-iyirmi">10 <i class="fa fa-arrows-h" aria-hidden="true"></i> 20<span class="k_ceki_10_20"></span></p>
							<p class="iyirmi-otuz">20 <i class="fa fa-arrows-h" aria-hidden="true"></i> 30<span class="k_ceki_20_30"></span></p>
							<p class="otuz-plus"><i class="fa fa-plus" aria-hidden="true"></i>  30 <span class="k_ceki_30_plus"></span></p>
						</div>
						...
						<div class="filter_divs cins col-xs-12">
							<p class="kisi">Kişilər üçün <span class="k_cins_kisi"></span></p>
							<p class="qadin">Qadınlar üçün <span class="k_cins_qadin"></span></p>
						</div>
						...
						<div class="filter_divs age_grupu col-xs-12">
							<p class="usaq">Uşaqlar üçün <span class="k_yasgrupu_usaq"></span></p>
							<p class="boyuk">Böyüklər üçün <span class="k_yasgrupu_boyuk"></span></p>
						</div>
