<?php session_start(); ?>
				...
				<head>
					...
					<link rel='alternate' hreflang='az' href='http://gumush.az/item/Boyuk-qara-ve-xirda-ag-cirkun-qaslarla-bezedilmis-qadin-gumus-uzuyu-364717/index.php' />
					<link rel='stylesheet' type='text/css' href='../../css/item.css'>
					<meta charset='utf-8'/>
					<meta http-equiv='X-UA-Compatible' content='IE=edge'>
					<link rel='author' href='https://plus.google.com/108728687434805525511/posts'/>
				   	<meta name='viewport' content='width=device-width, initial-scale=1'>
				   	<meta property='og:url' content='http://gumush.az/item/Boyuk-qara-ve-xirda-ag-cirkun-qaslarla-bezedilmis-qadin-gumus-uzuyu-364717/' />
					<meta property='og:type' content='website' />
					<meta property='og:title' content='Böyük qara və xırda ağ çirkun qaşlarla bəzədilmiş qadin gumus uzuyu' />
					<meta property='og:description' content='5.3 Qram - 34 AZN' />
					<meta property='og:image' content='http://gumush.az/item/Boyuk-qara-ve-xirda-ag-cirkun-qaslarla-bezedilmis-qadin-gumus-uzuyu-364717/image0.jpg' />
				...
				<body>
					...
					<script type='text/javascript'>
						$(document).ready(function(){
						    document.title = 'Böyük qara və xırda ağ çirkun qaşlarla bəzədilmiş qadin gumus uzuyu';
						    setTimeout(function(){
						    	$('.circle').hide();
						    	$('.circle1').hide();
						...
						<!-- ITEM START -->
							<div class='row main_divs_space item_main'>
								<div class='col-xs-12 item-top-nav main_divs_space'>
									...
									<p>Böyük qara və xırda ağ çirkun qaşlarla bəzədilmiş qadin gumus uzuyu</p>
								</div>
								<div>
									...
									<div class='item_info col-md-3 col-sm-4'>
										<h1>Böyük qara və xırda ağ çirkun qaşlarla bəzədilmiş qadin gumus uzuyu</h1>
										<p class='item_weight'>Çəki: <span>5.3</span></p>
									...
									<div class='item_buy col-md-3 col-sm-3'>
										...
										<div class='item_btn_div'>
											<button onclick='nece_eded_sifarish(this.id)' id='mehsul188' class='btn btn-success'>Səbətə əlavə et</button>
										</div>
									</div>
								</div>
