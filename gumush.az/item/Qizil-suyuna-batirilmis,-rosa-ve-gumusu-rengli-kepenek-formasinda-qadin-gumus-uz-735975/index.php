<?php session_start(); ?>
				...
				<head>
					...
					<link rel='alternate' hreflang='az' href='http://gumush.az/item/Qizil-suyuna-batirilmis,-rosa-ve-gumusu-rengli-kepenek-formasinda-qadin-gumus-uz-735975/index.php' />
					<link rel='stylesheet' type='text/css' href='../../css/item.css'>
					<meta charset='utf-8'/>
					<meta http-equiv='X-UA-Compatible' content='IE=edge'>
					<link rel='author' href='https://plus.google.com/108728687434805525511/posts'/>
				   	<meta name='viewport' content='width=device-width, initial-scale=1'>
				   	<meta property='og:url' content='http://gumush.az/item/Qizil-suyuna-batirilmis,-rosa-ve-gumusu-rengli-kepenek-formasinda-qadin-gumus-uz-735975/' />
					<meta property='og:type' content='website' />
					<meta property='og:title' content='Qızıl suyuna batırılmış, rosa və gümüşü rəngli kəpənək formasında qadin gumus uz' />
					<meta property='og:description' content='9.5 Qram - 57 AZN' />
					<meta property='og:image' content='http://gumush.az/item/Qizil-suyuna-batirilmis,-rosa-ve-gumusu-rengli-kepenek-formasinda-qadin-gumus-uz-735975/image0.jpg' />
				...
				<body>
					...
					<script type='text/javascript'>
						$(document).ready(function(){
						    document.title = 'Qızıl suyuna batırılmış, rosa və gümüşü rəngli kəpənək formasında qadin gumus uz';
						    setTimeout(function(){
						    	$('.circle').hide();
						    	$('.circle1').hide();
						...
						<!-- ITEM START -->
							<div class='row main_divs_space item_main'>
								<div class='col-xs-12 item-top-nav main_divs_space'>
									...
									<p>Qızıl suyuna batırılmış, rosa və gümüşü rəngli kəpənək formasında qadin gumus uz</p>
								</div>
								<div>
									<div class='item_img col-md-6 col-sm-5'>
										<img class='slider_img' src='image0.jpg' alt='qadin gumus uzukleri'>
										<div class='col-xs-12 tumb_main'>
											<?php
											for($b=0;$b<2;$b++){
												echo "
														<div class='col-xs-3 item_img_tumb'>
															<img onclick='change_img(this.src)' src='image".$b.".jpg' height='110' alt='qadin gumus uzukleri' />
														</div>
												";
											}
											?>
									...
									<div class='item_info col-md-3 col-sm-4'>
										<h1>Qızıl suyuna batırılmış, rosa və gümüşü rəngli kəpənək formasında qadin gumus uz</h1>
										<p class='item_weight'>Çəki: <span>9.5</span></p>
										<p class='item_olcu'>Ölçü: <span>Hər ölçüdə var</span></p>
										<p class='item_qas'>Qaş: <span>Var</span></p>
									...
									<div class='item_buy col-md-3 col-sm-3'>
										...
										<div class='item_btn_div'>
											<button onclick='nece_eded_sifarish(this.id)' id='mehsul190' class='btn btn-success'>Səbətə əlavə et</button>
										</div>
									</div>
								</div>
