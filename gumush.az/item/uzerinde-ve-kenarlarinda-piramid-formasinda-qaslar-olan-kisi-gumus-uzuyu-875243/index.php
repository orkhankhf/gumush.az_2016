<?php session_start(); ?>
				...
				<head>
					...
					<link rel='alternate' hreflang='az' href='http://gumush.az/item/uzerinde-ve-kenarlarinda-piramid-formasinda-qaslar-olan-kisi-gumus-uzuyu-875243/index.php' />
					<link rel='stylesheet' type='text/css' href='../../css/item.css'>
					<meta charset='utf-8'/>
					<meta http-equiv='X-UA-Compatible' content='IE=edge'>
					<link rel='author' href='https://plus.google.com/108728687434805525511/posts'/>
				   	<meta name='viewport' content='width=device-width, initial-scale=1'>
				   	<meta property='og:url' content='http://gumush.az/item/uzerinde-ve-kenarlarinda-piramid-formasinda-qaslar-olan-kisi-gumus-uzuyu-875243/' />
					<meta property='og:type' content='website' />
					<meta property='og:title' content='Üzərində və kənarlarında piramid formasında qaşlar olan kisi gumus uzuyu' />
					<meta property='og:description' content='5.4 Qram - 35 AZN' />
					<meta property='og:image' content='http://gumush.az/item/uzerinde-ve-kenarlarinda-piramid-formasinda-qaslar-olan-kisi-gumus-uzuyu-875243/image0.jpg' />
				...
				<body>
					...
					<script type='text/javascript'>
						$(document).ready(function(){
						    document.title = 'Üzərində və kənarlarında piramid formasında qaşlar olan kisi gumus uzuyu';
						    setTimeout(function(){
						    	$('.circle').hide();
						    	$('.circle1').hide();
						...
						<!-- ITEM START -->
							<div class='row main_divs_space item_main'>
								<div class='col-xs-12 item-top-nav main_divs_space'>
									...
									<p>Üzərində və kənarlarında piramid formasında qaşlar olan kisi gumus uzuyu</p>
								</div>
								<div>
									...
									<div class='item_info col-md-3 col-sm-4'>
										<h1>Üzərində və kənarlarında piramid formasında qaşlar olan kisi gumus uzuyu</h1>
										<p class='item_weight'>Çəki: <span>5.4</span></p>
									...
									<div class='item_buy col-md-3 col-sm-3'>
										...
										<div class='item_btn_div'>
											<button onclick='nece_eded_sifarish(this.id)' id='mehsul181' class='btn btn-success'>Səbətə əlavə et</button>
										</div>
									</div>
								</div>
