<?php session_start(); ?>
				...
				<head>
					...
					<link rel='alternate' hreflang='az' href='http://gumush.az/item/Sade-matt-ve-parlaq-cizgilerle-bezedilmis-kisi-gumus-uzuyu-135775/index.php' />
					<link rel='stylesheet' type='text/css' href='../../css/item.css'>
					<meta charset='utf-8'/>
					<meta http-equiv='X-UA-Compatible' content='IE=edge'>
					<link rel='author' href='https://plus.google.com/108728687434805525511/posts'/>
				   	<meta name='viewport' content='width=device-width, initial-scale=1'>
				   	<meta property='og:url' content='http://gumush.az/item/Sade-matt-ve-parlaq-cizgilerle-bezedilmis-kisi-gumus-uzuyu-135775/' />
					<meta property='og:type' content='website' />
					<meta property='og:title' content='Sadə matt və parlaq çizgilərlə bəzədilmiş kisi gumus uzuyu' />
					<meta property='og:description' content='5.4 Qram - 35 AZN' />
					<meta property='og:image' content='http://gumush.az/item/Sade-matt-ve-parlaq-cizgilerle-bezedilmis-kisi-gumus-uzuyu-135775/image0.jpg' />
				...
				<body>
					...
					<script type='text/javascript'>
						$(document).ready(function(){
						    document.title = 'Sadə matt və parlaq çizgilərlə bəzədilmiş kisi gumus uzuyu';
						    setTimeout(function(){
						    	$('.circle').hide();
						    	$('.circle1').hide();
						...
						<!-- ITEM START -->
							<div class='row main_divs_space item_main'>
								<div class='col-xs-12 item-top-nav main_divs_space'>
									...
									<p>Sadə matt və parlaq çizgilərlə bəzədilmiş kisi gumus uzuyu</p>
								</div>
								<div>
									...
									<div class='item_info col-md-3 col-sm-4'>
										<h1>Sadə matt və parlaq çizgilərlə bəzədilmiş kisi gumus uzuyu</h1>
									...
									<div class='item_buy col-md-3 col-sm-3'>
										...
										<div class='item_btn_div'>
											<button onclick='nece_eded_sifarish(this.id)' id='mehsul166' class='btn btn-success'>Səbətə əlavə et</button>
										</div>
									</div>
								</div>
