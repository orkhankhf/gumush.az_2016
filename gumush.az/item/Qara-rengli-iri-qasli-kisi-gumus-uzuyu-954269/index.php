<?php session_start(); ?>
				...
				<head>
					...
					<link rel='alternate' hreflang='az' href='http://gumush.az/item/Qara-rengli-iri-qasli-kisi-gumus-uzuyu-954269/index.php' />
					<link rel='stylesheet' type='text/css' href='../../css/item.css'>
					<meta charset='utf-8'/>
					<meta http-equiv='X-UA-Compatible' content='IE=edge'>
					<link rel='author' href='https://plus.google.com/108728687434805525511/posts'/>
				   	<meta name='viewport' content='width=device-width, initial-scale=1'>
				   	<meta property='og:url' content='http://gumush.az/item/Qara-rengli-iri-qasli-kisi-gumus-uzuyu-954269/' />
					<meta property='og:type' content='website' />
					<meta property='og:title' content='Qara rəngli iri qaşlı kisi gumus uzuyu' />
					<meta property='og:description' content='12.9 Qram - 77 AZN' />
					<meta property='og:image' content='http://gumush.az/item/Qara-rengli-iri-qasli-kisi-gumus-uzuyu-954269/image0.jpg' />
				...
				<body>
					...
					<script type='text/javascript'>
						$(document).ready(function(){
						    document.title = 'Qara rəngli iri qaşlı kisi gumus uzuyu';
						    setTimeout(function(){
						    	$('.circle').hide();
						    	$('.circle1').hide();
						...
						<!-- ITEM START -->
							<div class='row main_divs_space item_main'>
								<div class='col-xs-12 item-top-nav main_divs_space'>
									...
									<p>Qara rəngli iri qaşlı kisi gumus uzuyu</p>
								</div>
								<div>
									...
									<div class='item_info col-md-3 col-sm-4'>
										<h1>Qara rəngli iri qaşlı kisi gumus uzuyu</h1>
										<p class='item_weight'>Çəki: <span>12.9</span></p>
									...
									<div class='item_buy col-md-3 col-sm-3'>
										...
										<div class='item_btn_div'>
											<button onclick='nece_eded_sifarish(this.id)' id='mehsul184' class='btn btn-success'>Səbətə əlavə et</button>
										</div>
									</div>
								</div>
