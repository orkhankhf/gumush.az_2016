<?php session_start(); ?>
				...
				<head>
					...
					<link rel='alternate' hreflang='az' href='http://gumush.az/item/Xirda-qaslarla-bezedilmis-ince-qadin-gumus-uzuyu-843204/index.php' />
					<link rel='stylesheet' type='text/css' href='../../css/item.css'>
					<meta charset='utf-8'/>
					<meta http-equiv='X-UA-Compatible' content='IE=edge'>
					<link rel='author' href='https://plus.google.com/108728687434805525511/posts'/>
				   	<meta name='viewport' content='width=device-width, initial-scale=1'>
				   	<meta property='og:url' content='http://gumush.az/item/Xirda-qaslarla-bezedilmis-ince-qadin-gumus-uzuyu-843204/' />
					<meta property='og:type' content='website' />
					<meta property='og:title' content='Xırda qaşlarla bəzədilmiş incə qadin gumus uzuyu' />
					<meta property='og:description' content='2.5 Qram - 17 AZN' />
					<meta property='og:image' content='http://gumush.az/item/Xirda-qaslarla-bezedilmis-ince-qadin-gumus-uzuyu-843204/image0.jpg' />
				...
				<body>
					...
					<script type='text/javascript'>
						$(document).ready(function(){
						    document.title = 'Xırda qaşlarla bəzədilmiş incə qadin gumus uzuyu';
						    setTimeout(function(){
						    	$('.circle').hide();
						    	$('.circle1').hide();
						...
						<!-- ITEM START -->
							<div class='row main_divs_space item_main'>
								<div class='col-xs-12 item-top-nav main_divs_space'>
									...
									<a href='' title=''></a>
									<p>Xırda qaşlarla bəzədilmiş incə qadin gumus uzuyu</p>
								</div>
								<div>
									...
									<div class='item_buy col-md-3 col-sm-3'>
										...
										<div class='item_btn_div'>
											<button onclick='nece_eded_sifarish(this.id)' id='mehsul162' class='btn btn-success'>Səbətə əlavə et</button>
										</div>
									</div>
								</div>
								...
								<div class='col-xs-12 item_oxsar_kateqoriya'>
									<button onclick='prev_items()' class='iox_btn-l'><i class='fa fa-arrow-left' aria-hidden='true'></i></button>
										<?php
											...
											if($conn){
												$sec = "SELECT basliq,qiymet,tmp,img_alt,a_title FROM mehsullar WHERE kateqoriya = '' ORDER BY RAND() LIMIT 15";
