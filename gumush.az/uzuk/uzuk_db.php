<?php
	...
	$select_uzukler = "SELECT * FROM mehsullar WHERE kateqoriya = 'uzuk'";
	...
	if(isset($_POST['k']) && !empty($_POST['k'])){
		$select_uzukler = $select_uzukler.=" AND olcu < 16";
	}
	if(isset($_POST['l']) && !empty($_POST['l'])){
		$select_uzukler = $select_uzukler.=" AND olcu BETWEEN 16 AND 18";
	}
	if(isset($_POST['m']) && !empty($_POST['m'])){
		$select_uzukler = $select_uzukler.=" AND olcu BETWEEN 18 AND 20";
	}
	if(isset($_POST['n']) && !empty($_POST['n'])){
		$select_uzukler = $select_uzukler.=" AND olcu BETWEEN 20 AND 22";
	}
	if(isset($_POST['o']) && !empty($_POST['o'])){
		$select_uzukler = $select_uzukler.=" AND olcu BETWEEN 22 AND 24";
	}
	//ceki
	...
	if(isset($_POST['b']) && !empty($_POST['b'])){
		$select_uzukler = $select_uzukler.=" AND cins = 'kisi'";
	}
	if(isset($_POST['c']) && !empty($_POST['c'])){
		$select_uzukler = $select_uzukler.=" AND cins = 'qadin'";
	}
	//yas
