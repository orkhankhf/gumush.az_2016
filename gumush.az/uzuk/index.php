...
<html>
<head>
	<link rel="alternate" hreflang="az" href="http://gumush.az/uzuk/index.php" />
	<meta http-equiv="content-language" content="az" />
	<meta name="keywords" content="gumus üzüklər,gümüş uzukler,qadin gumusleri,kisi gumusleri,usaq gumusleri,uzuk satisi,gumus satisi bakida,uzuk,sep,qadın və kişi gümüşləri,online gumus satisi" />
	...
	<meta property="og:url" content="http://gumush.az/uzuk/" />
	<meta property="og:type" content="website" />
	<meta property="og:title" content="Qadın Və Kişi Gümüş Üzüklərinin Onlayn Satışı" />
...
<body onload="pagination_sayisi()">
	...
	<div class="container">
		...
		<h1 class="seo_h1">Gümüş Üzüklər Gumus Uzukler Qadın Gümüşləri Qadin Gumusleri Kişi Gümüşləri Kisi Gumusleri Qadın Üzükləri Qadin Uzukleri Kişi Üzükləri Kisi Uzukleri</h1>
		<!-- SIFARISH POP-UP'S START -->
			...
			<script type="text/javascript">
				...
				//sebetdeki limit dolubsa alis verisi bitirmek ucun sebete gedir
		...
		<script type="text/javascript">
			$("a[href='../uzuk']").css("background-color","#ED5258");
		</script>
		...
		<!-- FILTER START -->
					<div class="filter_main col-xs-12 col-sm-3">
								...
								//bu funksiya ise dusur, mehsul_sayisi_pagination adli deyiskenin deyeri teyin olunur ve sonra pagination_sayisi() funksiyasi ise dusur, funksiya asagilarda bir yerdedir.
									$.ajax({
									    ...
									    success: function (data){
									        ...
									        $(".u_qiymet_10_30").html(" ("+mehsul_eded[0].u_qiymet_10_30+")");
									        $(".u_qiymet_30_50").html(" ("+mehsul_eded[0].u_qiymet_30_50+")");
									        $(".u_qiymet_50_70").html(" ("+mehsul_eded[0].u_qiymet_50_70+")");
									        $(".u_qiymet_70_100").html(" ("+mehsul_eded[0].u_qiymet_70_100+")");
									        $(".u_qiymet_100_plus").html(" ("+mehsul_eded[0].u_qiymet_100_plus+")");
									        //olcu legv edildi
									        // $(".u_olcu_16_minus").html(" ("+mehsul_eded[0].u_olcu_16_minus+")");
									        // $(".u_olcu_16_18").html(" ("+mehsul_eded[0].u_olcu_16_18+")");
									        // $(".u_olcu_18_20").html(" ("+mehsul_eded[0].u_olcu_18_20+")");
									        // $(".u_olcu_20_22").html(" ("+mehsul_eded[0].u_olcu_20_22+")");
									        // $(".u_olcu_22_24").html(" ("+mehsul_eded[0].u_olcu_22_24+")");

									        $(".u_ceki_1_5").html(" ("+mehsul_eded[0].u_ceki_1_5+")");
									        $(".u_ceki_5_10").html(" ("+mehsul_eded[0].u_ceki_5_10+")");
									        $(".u_ceki_10_20").html(" ("+mehsul_eded[0].u_ceki_10_20+")");
									        $(".u_ceki_20_30").html(" ("+mehsul_eded[0].u_ceki_20_30+")");
									        $(".u_ceki_30_plus").html(" ("+mehsul_eded[0].u_ceki_30_plus+")");

									        $(".u_cins_kisi").html(" ("+mehsul_eded[0].u_cins_kisi+")");
									        $(".u_cins_qadin").html(" ("+mehsul_eded[0].u_cins_qadin+")");

									        $(".u_yasgrupu_usaq").html(" ("+mehsul_eded[0].u_yasgrupu_usaq+")");
									        $(".u_yasgrupu_boyuk").html(" ("+mehsul_eded[0].u_yasgrupu_boyuk+")");
									    }
									});
						</script>
						...
						<div class="filter_divs kateqoriya col-xs-12">
							<a href="." title="gumus Uzukler">Üzüklər <span class="mehsul_eded-uzuk"></span></a>
							...
							<a href="../boyunbagi" title="gumus Boyunbagilar">Boyunbağılar <span class="mehsul_eded-boyunbagi"></span></a>
						...
						<div class="filter_divs qiymet col-xs-12">
							<p class="on-otuz">10 <i class="fa fa-arrows-h" aria-hidden="true"></i> 30 AZN<span class="u_qiymet_10_30"></span></p>
							<p class="otuz-elli">30 <i class="fa fa-arrows-h" aria-hidden="true"></i> 50 AZN<span class="u_qiymet_30_50"></span></p>
							<p class="elli-yetmis">50 <i class="fa fa-arrows-h" aria-hidden="true"></i> 70 AZN<span class="u_qiymet_50_70"></span></p>
							<p class="yetmis-yuz">70 <i class="fa fa-arrows-h" aria-hidden="true"></i> 100 AZN<span class="u_qiymet_70_100"></span></p>
							<p class="yuz-plus"><i class="fa fa-plus" aria-hidden="true"></i> 100 AZN<span class="u_qiymet_100_plus"></span></p>
						</div>
						<!-- olcu legv edildi
						<p class="filter_headers">Ölçü<i class="toggle_olcu fa fa-plus-circle" aria-hidden="true"></i></p>
						<div class="filter_divs olcu col-xs-12">
							<p class="onalti-minus"><i class="fa fa-minus" aria-hidden="true"></i> 16<span class="u_olcu_16_minus"></span></p>
							<p class="onalti-onsekkiz">16 <i class="fa fa-arrows-h" aria-hidden="true"></i> 18<span class="u_olcu_16_18"></span></p>
							<p class="onsekkiz-iyirmi">18 <i class="fa fa-arrows-h" aria-hidden="true"></i> 20<span class="u_olcu_18_20"></span></p>
							<p class="iyirmi-iyirimiiki">20 <i class="fa fa-arrows-h" aria-hidden="true"></i> 22<span class="u_olcu_20_22"></span></p>
							<p class="iyirimiiki-iyirmidort">22 <i class="fa fa-arrows-h" aria-hidden="true"></i> 24<span class="u_olcu_22_24"></span></p>
						</div>
						-->
						...
						<div class="filter_divs ceki col-xs-12">
							<p class="bir-bes">1 <i class="fa fa-arrows-h" aria-hidden="true"></i> 5<span class="u_ceki_1_5"></span></p>
							<p class="bes-on">5 <i class="fa fa-arrows-h" aria-hidden="true"></i> 10<span class="u_ceki_5_10"></span></p>
							<p class="on-iyirmi">10 <i class="fa fa-arrows-h" aria-hidden="true"></i> 20<span class="u_ceki_10_20"></span></p>
							<p class="iyirmi-otuz">20 <i class="fa fa-arrows-h" aria-hidden="true"></i> 30<span class="u_ceki_20_30"></span></p>
							<p class="otuz-plus"><i class="fa fa-plus" aria-hidden="true"></i>  30 <span class="u_ceki_30_plus"></span></p>
						</div>
						...
						<div class="filter_divs cins col-xs-12">
							<p class="kisi">Kişilər üçün <span class="u_cins_kisi"></span></p>
							<p class="qadin">Qadınlar üçün <span class="u_cins_qadin"></span></p>
						</div>
						...
						<div class="filter_divs age_grupu col-xs-12">
							<p class="usaq">Uşaqlar üçün <span class="u_yasgrupu_usaq"></span></p>
							<p class="boyuk">Böyüklər üçün <span class="u_yasgrupu_boyuk"></span></p>
						</div>
		...
		<!-- SELLLIST START -->
					<div class="sellList uzukler_main col-xs-12 col-sm-9">
						<div class="row uzukler_ajax sell_list_opacity">
							<script type="text/javascript">
								...
								var onalti_onsekkiz = "";
								var onsekkiz_iyirmi = "";
								var iyirmi_iyirimiiki = "";
								var iyirimiiki_iyirmidort = "";
								//ceki
								var bir_bes_gram = "";
								var bes_on_gram = "";
								var on_iyirmi_gram = "";
					            ...
					            function ajax(){
					            	$.ajax({
						                type: "POST",
						                url: "uzuk_db.php",
						                data: { a: '',b: kisi,c: qadin,d:usaq,e:boyuk,f:bir_bes_gram,g:bes_on_gram,h:on_iyirmi_gram,i:iyirmi_otuz_gram,j:otuz_plus,k:onalti_minus,l:onalti_onsekkiz,m:onsekkiz_iyirmi,n:iyirmi_iyirimiiki,o:iyirimiiki_iyirmidort,p:on_otuz,q:otuz_elli,r:elli_yetmis,s:yetmis_yuz,t:yuz_plus,u:st,v:lm},
						                success: function(gelen) {
					            ...
					            $(".onalti-minus").click(function(){
					            	...
					            	if(onalti_minus==""){
										...
										onsekkiz_iyirmi = "";
										iyirmi_iyirimiiki = "";
										iyirimiiki_iyirmidort = "";
										$(".onalti-minus").addClass("selected_filter");
										$(".onalti-onsekkiz,.onsekkiz-iyirmi,.iyirmi-iyirimiiki,.iyirimiiki-iyirmidort").removeClass("selected_filter");
										ajax();
										setTimeout(function(){
											pagination_sayisi();
										},50);
										...
										onalti_minus = "";
										$(".onalti-minus").removeClass("selected_filter");
										ajax();
										setTimeout(function(){
											pagination_sayisi();
										},50);
					            ...
					            $(".onalti-onsekkiz").click(function(){
					            	st = 0;
					            	current_page = 1;
					            	sehife = 1;
					            	if(onalti_onsekkiz==""){
										...
										iyirmi_iyirimiiki = "";
										iyirimiiki_iyirmidort = "";
										$(".onalti-onsekkiz").addClass("selected_filter");
										$(".onalti-minus,.onsekkiz-iyirmi,.iyirmi-iyirimiiki,.iyirimiiki-iyirmidort").removeClass("selected_filter");
										ajax();
										setTimeout(function(){
											pagination_sayisi();
										},50);
										...
										onalti_onsekkiz = "";
										$(".onalti-onsekkiz").removeClass("selected_filter");
										ajax();
										setTimeout(function(){
											pagination_sayisi();
										},50);
					            ...
					            $(".onsekkiz-iyirmi").click(function(){
					            	st = 0;
					            	current_page = 1;
					            	sehife = 1;
					            	if(onsekkiz_iyirmi==""){
										...
										iyirmi_iyirimiiki = "";
										iyirimiiki_iyirmidort = "";
										$(".onsekkiz-iyirmi").addClass("selected_filter");
										$(".onalti-minus,.onalti-onsekkiz,.iyirmi-iyirimiiki,.iyirimiiki-iyirmidort").removeClass("selected_filter");
										ajax();
										setTimeout(function(){
											pagination_sayisi();
										},50);
										...
										onsekkiz_iyirmi = "";
										$(".onsekkiz-iyirmi").removeClass("selected_filter");
										ajax();
										setTimeout(function(){
											pagination_sayisi();
										},50);
					            ...
					            $(".iyirmi-iyirimiiki").click(function(){
					            	st = 0;
					            	current_page = 1;
					            	sehife = 1;
					            	if(iyirmi_iyirimiiki==""){
										onalti_minus = "";
										onalti_onsekkiz = "";
										onsekkiz_iyirmi = "";
										iyirmi_iyirimiiki = "1";
										iyirimiiki_iyirmidort = "";
										$(".iyirmi-iyirimiiki").addClass("selected_filter");
										$(".onalti-minus,.onalti-onsekkiz,.onsekkiz-iyirmi,.iyirimiiki-iyirmidort").removeClass("selected_filter");
										ajax();
										setTimeout(function(){
											pagination_sayisi();
										},50);
										...
										iyirmi_iyirimiiki = "";
										$(".iyirmi-iyirimiiki").removeClass("selected_filter");
										ajax();
										setTimeout(function(){
											pagination_sayisi();
										},50);
					            ...
					            $(".iyirimiiki-iyirmidort").click(function(){
					            	st = 0;
					            	current_page = 1;
					            	sehife = 1;
					            	if(iyirimiiki_iyirmidort==""){
										onalti_minus = "";
										onalti_onsekkiz = "";
										onsekkiz_iyirmi = "";
										iyirmi_iyirimiiki = "";
										iyirimiiki_iyirmidort = "1";
										$(".iyirimiiki-iyirmidort").addClass("selected_filter");
										$(".onalti-minus,.onalti-onsekkiz,.onsekkiz-iyirmi,.iyirmi-iyirimiiki").removeClass("selected_filter");
										ajax();
										setTimeout(function(){
											pagination_sayisi();
										},50);
										...
										iyirimiiki_iyirmidort = "";
										$(".iyirimiiki-iyirmidort").removeClass("selected_filter");
										ajax();
										setTimeout(function(){
											pagination_sayisi();
										},50);
			...
			<script type="text/javascript">
				...
				//olcu legv edildi
				// $(".toggle_olcu").click(function(){
				// 	$(this).toggleClass("fa-minus-circle");
				// 	$(".olcu").slideToggle(400);/*menu 5 denedirse 600(+1), 3 denedirse 400, 2 denedirse 300 yaz*/
				// })
